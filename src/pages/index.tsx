...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`StarterNext`}</title>

        <meta
          name="description"
          content="Welcome to StarterNext - Your Personalized Outfit Generator. Click, Lock, and Explore New Combinations for a Unique Style Statement Every Time."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1551232864-3f0890e580d9?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxvdXRmaXRzfGVufDB8fHx8MTY5NDM2ODQxOHww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@amandavickcreative?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Amanda Vick`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to StarterNext - Your Personalized Outfit Generator. Click, Lock, and Explore New Combinations for a Unique Style Statement Every Time.`}
            </Text>
            <Box
